...
{   
    ...
    // bounds.setLow(-1);
    // bounds.setHigh(1);
	bounds.setLow(0,-20);//-5
	bounds.setHigh(0,20);//+5
	bounds.setLow(1,-20);//-5
	bounds.setHigh(1,20);//+5
	bounds.setLow(2,-10);//-2
...
void cust_callback(const octomap_msgs::Octomap::ConstPtr &msg,const geometry_msgs::TransformStamped::ConstPtr &pose)
{
	...
	//const std::string filename = "/home/maurya/Gazebo_fount_pearl5";
