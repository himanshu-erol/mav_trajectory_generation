...
{   ros::NodeHandle n;
	...
	ob::ScopedState<ob::SE3StateSpace> goal(space);
     ...
     //goal->as<ob::RealVectorStateSpace::StateType>(0)->values[0] = -1.0;//try to use this insteadof above two lines
     //goal->as<ob::RealVectorStateSpace::StateType>(0)->values[1] = -2.0;
     //goal->as<ob::RealVectorStateSpace::StateType>(0)->values[2] = -1.0;
	//goal.random();
